...
function addAppointment($data){
    $conn = db_conn();
    $selectQuery = "INSERT INTO history_info( Name ,Email, Speciality, Schedule, Gender,Appointment_Date,Status)
VALUES (:Name,:Email, :Speciality, :Schedule, :Gender, :Appointment_Date, :Status)";
    echo 'again';
